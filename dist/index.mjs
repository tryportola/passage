...
var BaseAPI = class {
  constructor(configuration, basePath = BASE_PATH, axios = globalAxios2) {
...
var ApplicationsApiAxiosParamCreator = function(configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    listApplications: async (status, productType, limit, offset, options = {}) => {
...
var ApplicationsApiFp = function(configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async listApplications(status, productType, limit, offset, options) {
...
var LoansApiAxiosParamCreator = function(configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    listLoans: async (status, limit, offset, options = {}) => {
...
var LoansApiFp = function(configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async listLoans(status, limit, offset, options) {
...
var BaseAPI2 = class {
  constructor(configuration, basePath = BASE_PATH2, axios = globalAxios2) {
    this.basePath = basePath;
    this.axios = axios;
    if (configuration) {
      this.configuration = configuration;
...
var BlobsApiFp = function(configuration) {
  ...
  return {
    ...
    async downloadBlob(documentHandle, options) {
      ...
      return (axios, basePath) => createRequestFunction2(localVarAxiosArgs, globalAxios2, BASE_PATH2, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * Upload an encrypted binary blob to SDX storage.  **Authentication**: Requires JWT token with `action: \"upload\"`  **Deduplication**: If an identical blob (same content hash) was previously uploaded for the same application, the existing document handle is returned without creating a duplicate.  **Idempotency**: Include an `Idempotency-Key` header to prevent duplicate uploads due to network retries. If a request with the same idempotency key is repeated, the original response is returned.  **Limitations**: - Maximum blob size: 100MB (configurable) - Content-Type must be `application/octet-stream` - Content-Length header is required 
     * @summary Upload encrypted blob
...
export { ApplicationsApi, AttestationApi, BlobsApi, Configuration, EntityDiscoveryApi, FundingApi, HealthApi, KeyManagementApi, LoansApi, NeobankSelfServiceApi, OffersApi, api_exports as PassageAPI, Configuration as PassageConfiguration, sdx_exports as PassageSDX, PlatformApi, QueueApi, SDXApi, SigningApi, TransfersApi, TreasuryApi };
