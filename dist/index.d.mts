...
declare const ApplicationRequestBorrowerWalletChainEnum: {
    readonly Base: "base";
...
type ApplicationRequestBorrowerWalletChainEnum = typeof ApplicationRequestBorrowerWalletChainEnum[keyof typeof ApplicationRequestBorrowerWalletChainEnum];
/**
 *
 * @export
...
declare const ApplicationsApiAxiosParamCreator: (configuration?: Configuration$1) => {
     ...
     * @throws {RequiredError}
     */
    listApplications: (status?: ApplicationStatus, productType?: ListApplicationsProductTypeEnum, externalId?: string, borrowerWalletAddress?: string, limit?: number, offset?: number, options?: RawAxiosRequestConfig) => Promise<RequestArgs$1>;
    /**
...
declare const ApplicationsApiFp: (configuration?: Configuration$1) => {
     ...
     * @throws {RequiredError}
     */
    listApplications(status?: ApplicationStatus, productType?: ListApplicationsProductTypeEnum, externalId?: string, borrowerWalletAddress?: string, limit?: number, offset?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListApplications200Response>>;
    /**
     * Neobank submits an encrypted loan application packet. The application is broadcast to all configured lenders supporting the product type.
     * @summary Submit loan application
     * @param {ApplicationRequest} applicationRequest
...
declare const LoansApiAxiosParamCreator: (configuration?: Configuration$1) => {
     ...
     * @throws {RequiredError}
     */
    listLoans: (status?: LoanStatus, externalId?: string, borrowerAddress?: string, limit?: number, offset?: number, options?: RawAxiosRequestConfig) => Promise<RequestArgs$1>;
    /**
...
declare const LoansApiFp: (configuration?: Configuration$1) => {
     ...
     * @throws {RequiredError}
     */
    listLoans(status?: LoanStatus, externalId?: string, borrowerAddress?: string, limit?: number, offset?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LoanListResponse>>;
    /**
     * Sweep balance from a loan\'s wallet to the master treasury wallet. Supports sweeping a specific amount or the full balance. Uses idempotency keys to prevent duplicate transfers. Lender-only endpoint.
     * @summary Sweep loan wallet
     * @param {string} loanId Unique identifier for the loan
...
declare const NeobankSelfServiceApiAxiosParamCreator: (configuration?: Configuration$1) => {
     ...
     * @throws {RequiredError}
     */
    getAccountStats: (options?: RawAxiosRequestConfig) => Promise<RequestArgs$1>;
    /**
...
declare const NeobankSelfServiceApiFp: (configuration?: Configuration$1) => {
     ...
     * @throws {RequiredError}
     */
    getAccountStats(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetAccountStats200Response>>;
    /**
     * Get current webhook configuration including URL and whether a secret is set. The webhook secret is never returned in full - only a masked preview. NEOBANK ONLY - Requires neobank API key authentication.
     * @summary Get webhook configuration
     * @param {*} [options] Override http request option.
...
declare class NeobankSelfServiceApi extends BaseAPI$1 implements NeobankSelfServiceApiInterface {
     ...
     * @memberof NeobankSelfServiceApi
     */
    getAccountStats(options?: RawAxiosRequestConfig): Promise<axios.AxiosResponse<GetAccountStats200Response, any, {}>>;
    /**
     * Get current webhook configuration including URL and whether a secret is set. The webhook secret is never returned in full - only a masked preview. NEOBANK ONLY - Requires neobank API key authentication.
     * @summary Get webhook configuration
     * @param {*} [options] Override http request option.
...
type index$1_ApplicationRequestBorrowerWalletChainEnum = ApplicationRequestBorrowerWalletChainEnum;
...
type index$1_GetAccountStats200Response = GetAccountStats200Response;
type index$1_GetAccountStats200ResponseData = GetAccountStats200ResponseData;
type index$1_GetAccountStats200ResponseDataApplications = GetAccountStats200ResponseDataApplications;
type index$1_GetAccountStats200ResponseDataBorrowers = GetAccountStats200ResponseDataBorrowers;
type index$1_GetAccountStats200ResponseDataLoans = GetAccountStats200ResponseDataLoans;
